...
//      checked : dùng để kiểm tra input ở html, xem người dùng có tick hay chưa
//     let loaiXe = document.querySelector("input [type='radio']:checked").value;
//     console.log(loaiXe);
//     DOM tới 3 input có type là radio
//     cấu trúc điều kiện tìm đến input có thể thì check = true
...
//          Tạo table chi tiết hóa đơn ở modal
  $("#myModal").modal("show");
